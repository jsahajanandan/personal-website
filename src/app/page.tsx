...
export default function Home() {
  return (
    <div>
                ...
                <div className="flip-card">
                  <div className="flip-card-inner">
                    <div className="flip-card-front ">
                      <div className="flip-card-innermost flex flex-col bg-white text-black rounded-lg shadow-lg p-6">
      ...
      <section id="contact" className="min-h-screen flex flex-col justify-center p-6 animation-slideIn">
